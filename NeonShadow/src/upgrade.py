...
class Item:
    ...
    def display_names(self, surface, name, cost, selected):
        ...
        # Title
        title_surf = self.font.render(name.upper(), False, color)
    ...
    def display_bar(self, surface, value, max_value, selected):
        # Drawing the stat bar inside the card
    ...
    def trigger(self, player):
        ...
        if player.exp >= player.upgrade_cost[upgrade_attribute] and \
           player.stats[upgrade_attribute] < player.max_stats[upgrade_attribute]:
            ...
            player.stats[upgrade_attribute] *= 1.2 # Boost stat by 20%
            player.upgrade_cost[upgrade_attribute] *= 1.4 # Increase cost
